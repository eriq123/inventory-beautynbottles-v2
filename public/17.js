...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    "app-raw-menu": function appRawMenu() {
      return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! @/components/pages/products/raw/rawMenu */ "./resources/js/components/pages/products/raw/rawMenu.vue"));
    }
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    getBaseUnits: function getBaseUnits() {
      ...
      this.loading = true;
      axios.post("/units/view").then(function (response) {
        _this.items = response.data.base;
        console.log(_this.items);
        _this.menu_name = _this.items[0].name;
        _this.loading = false;
  ...
  watch: {
    "items.name": function () {
      var _itemsName = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(value, oldVal) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.menu_name = this.items[0].name;
                console.log(value);
                console.log("something change in items name");
      ...
      function itemsName(_x, _x2) {
        return _itemsName.apply(this, arguments);
      }
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("app-raw-menu", {
                        attrs: { menu: _vm.items, selected: _vm.menu_name },
