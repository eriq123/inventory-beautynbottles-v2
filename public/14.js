...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    "app-raw-dialog": function appRawDialog() {
      return __webpack_require__.e(/*! import() */ 13).then(__webpack_require__.bind(null, /*! ./dialog.vue */ "./resources/js/components/pages/products/raw/dialog.vue"));
    },
  ...
  methods: {
    ...
    getOrFilterRaw: function getOrFilterRaw() {
      ...
      axios.post("/products/raw/view", {
        ...
        _this2.rawItems = response.data.raw.map(function (raw) {
    ...
    saveUpdateRaw: function saveUpdateRaw() {
      ...
      axios.post(this.dialog.operation == "Add" ? "/products/raw/add" : "/products/raw/update", this.formData).then(function (response) {
