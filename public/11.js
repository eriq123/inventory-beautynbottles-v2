...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    "app-report-datatable": function appReportDatatable() {
      return __webpack_require__.e(/*! import() */ 12).then(__webpack_require__.bind(null, /*! ./report/datatable.vue */ "./resources/js/components/pages/inventory/report/datatable.vue"));
    },
    "app-download-excel": vue_json_excel__WEBPACK_IMPORTED_MODULE_1__["default"],
    "app-datepicker": function appDatepicker() {
      return __webpack_require__.e(/*! import() */ 13).then(__webpack_require__.bind(null, /*! ./report/datepicker.vue */ "./resources/js/components/pages/inventory/report/datepicker.vue"));
    }
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    prepareHeader: function prepareHeader() {
      ...
      this.filename = "Inventory Report ".concat(from_date, " - ").concat(to_date);
      this.header = "Eshop Beauty and Bottles Online Shop\n Inventory Report\n ".concat(from_date, " - ").concat(to_date);
    },
              ...
              _c(
                ...
                [
                  _c("v-icon", { attrs: { left: "" } }, [
                    _vm._v("mdi-clipboard-arrow-down-outline")
                  ]),
                  _vm._v("\n                Download Report\n            ")
                ],
                1
